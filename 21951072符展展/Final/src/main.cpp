...
int main() {
    ...
    Shader bobShader("shaders/bob.vs", "shaders/bob.fs");
...
//    nanosuit.LoadMesh("models/nanosuit/nanosuit.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        bobShader.setMat4("M", model);
        bobShader.setVec3("lightPos", vec3(3 * cos(currentFrame), 3, 3 * sin(currentFrame)));
        bobShader.setVec3("viewPos", camera.Position);
